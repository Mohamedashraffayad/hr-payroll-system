...
def seed_data():
    ...
    # Companies
    companies = [
        ('ECGS1','الشركة المصرية للمقاولات والتوريدات العامة1'),
        ('ECGS2','الشركة المصرية للمقاولات والتوريدات العامة 2'),
        ('ECGS3','الشركة المصرية للمقاولات والتوريدات العامة 3'),
        ('ECGS4','الشركة المصرية للمقاولات والتوريدات العامة 4'),
        ('ECGS5','الشركة المصرية للمقاولات والتوريدات العامة 5')
    ]
    ...
    def do_POST(self):
        ...
        try:
            ...
            if self.path == '/api/auth/login':
                ...
                c.execute("""
                    SELECT u.*, e.name_en, e.name_ar, e.employee_code
                    FROM users u
                ...
                if user:
                    ...
                    self._json_response({
                        ...
                        'user': {
                            ...
                            'name_en': user[7],
                            'name_ar': user[8],
                            'employee_code': user[9]
                        }
                    })
                else:
                    self._error_response('Invalid credentials', 401)
